...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_kori_sisaltaa_ostosolion_jolla_oikea_nimi_ja_lukumaara(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_kaksi_samaa_tuotetta_toisen_poistaminen_jattaa_koriin_ostosolion_jonka_lukumaara_on_yksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_ainoan_tuotteen_poistamisen_jalkeen_kori_on_tyhja(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.poista_tuote(self.maito)
    ...
    def test_kori_tyhjenee_kun_se_tyhjennetaan(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.kahvi)
        self.kori.tyhjenna()
